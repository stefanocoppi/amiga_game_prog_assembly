...
; enables blitter nasty (bit 10) 
                     ;5432109876543210
DMASET           equ %1000011111000000             
...
.check_bgnd_end:
                 ...
                 ble        .check_draw_new_column
                 move.w     #0,bgnd_x                                    ; resets x position of the part of background to draw
                 cmp.w      #1,draw_buffer_idx
                 beq        .set_dbuffer1
                 cmp.w      #2,draw_buffer_idx
                 beq        .set_dbuffer2
                 bra        .check_draw_new_column
.set_dbuffer1:
                 move.l     #dbuffer1,draw_buffer
                 move.l     #dbuffer2,view_buffer
                 bra        .init_bplpointers
.set_dbuffer2:
...
.init_bplpointers: 
                 ...
                 ;bsr        swap_buffers
                 move.w     #$00ff,scrollx                               ; resets scroll value
                 ;move.w     #1,reset_scroll
                 bra        .return

.check_draw_new_column:       
...
;************************************************************************
                 ...
                 ds.b       (BGND_HEIGHT*(64/8)*N_PLANES)
